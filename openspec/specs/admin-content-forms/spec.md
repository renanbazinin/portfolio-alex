# admin-content-forms Specification

## Purpose
Admin project and settings forms: validation error display, unsaved-changes protection, media uploads, and admin imagery optimization. (TBD: expand as capability evolves.)
