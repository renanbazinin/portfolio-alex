# admin-project-management Specification

## Purpose
Dashboard project-list management: list mutations, pending feedback, deletion confirmation, and reordering behavior. (TBD: expand as capability evolves.)
